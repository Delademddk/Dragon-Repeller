...
const locations=[
  ...
  },
  {
    ...
    text: 'The monster died. You gained experience and gold'
  },
  {
    name: "lose",
...
function buyWeapon(){
  if(currentWeapon < weapons.length - 1)
    ...
    button2.innerText= 'Sell current weapon for 15 gold';
...
function attack(){
  text.innerText = "The " + monsters[fighting].name + " attcks.";
  text.innerText += "You should attck it with your " + weapons[currentWeapon].name + ".";
...
function dodge(){
  text.innerText = " You dogded the attck from " + monsters[fighting].name;
}
